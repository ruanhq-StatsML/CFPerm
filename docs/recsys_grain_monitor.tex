...
Covariate south order: MMD $0.35$, $\Vert\Delta X\Vert=2.55$, PO $=7.59e-05$, $\Delta\mathbb{E}[Y]=0.349$; north MMD $=0.00109$. Concept south order: MMD $=-0.00137$, PO $=0.00307$, $\Delta\mathbb{E}[Y]=-0.0412$.
