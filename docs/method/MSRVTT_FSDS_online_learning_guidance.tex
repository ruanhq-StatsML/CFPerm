...
In short, the offline FSDS readout is the design matrix for the next round of streaming results: adapt vision and audio, cluster by video, and treat clip-level text as a negative control.
