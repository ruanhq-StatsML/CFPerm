...
\section{Conclusion}
We proposed AGOD, an online distillation framework where modality-specific gap decomposition acts as a clever covariate. By routing distillation capacity toward drifting modalities, AGOD offers a principled alternative to static and covariate-only distillation.
