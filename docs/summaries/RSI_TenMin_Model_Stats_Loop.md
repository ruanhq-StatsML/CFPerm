# RSI 20 分钟自迭代：模型 / 统计效率（不锁场景）

> 节奏：**每 20 分钟一轮** — 自我更新 · 自我修复 · 自我迭代。  
> 视角：**模型与统计方法**（null、校准、FLOPs、偏相关、学习曲线、技能变点、PO-risk），  
> **不**锁商业车道。旁路组合现栈；**不改写** null / PO / soft_burn 核。  
> 主文：[`RSI_ML_Method_Opportunities_20min.md`](./RSI_ML_Method_Opportunities_20min.md)
...
| 分 | 动作 | 产出 |
|---:|---|---|
| 0–2 | 抽一张「方法约束卡」 | 本轮不许重复上一轮点 |
| 2–7 | **发散**：写 1 个跨 pack 的模型/统计点子 | 1 句 idea + 假设 |
| 7–12 | **Justify**：用可检的统计/ML 语言说明为什么值 | 定义量 / H0 / 效率 |
| 12–18 | **落地**：旁路 ≤1 模块 + 测试；不改核 | diff / green tests |
| 18–20 | 写效果 + 账本一行 + commit/push | log 行 |
