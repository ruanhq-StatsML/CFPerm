# FSDS multi-step iteration `iter04/_tmp_k10_s0_A_baseline_F`
...
- Best **W2** HGB AUC: `A_baseline_F|W1hold` = 0.3687 (baseline A=0.3687)
- Best **W1-hold** HGB AUC: `A_baseline_F|W1hold` = 0.5638
