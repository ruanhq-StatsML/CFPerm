# FSDS multi-step iteration `iter04/_tmp_k8_s2_A_baseline_F`
...
- Best **W2** HGB AUC: `A_baseline_F|W1hold` = 0.8224 (baseline A=0.8224)
- Best **W1-hold** HGB AUC: `A_baseline_F|W1hold` = 0.5708
