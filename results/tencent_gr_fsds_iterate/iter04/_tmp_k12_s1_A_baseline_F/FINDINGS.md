# FSDS multi-step iteration `iter04/_tmp_k12_s1_A_baseline_F`
...
- Best **W2** HGB AUC: `A_baseline_F|W1hold` = 0.7429 (baseline A=0.7429)
- Best **W1-hold** HGB AUC: `A_baseline_F|W1hold` = 0.5921
